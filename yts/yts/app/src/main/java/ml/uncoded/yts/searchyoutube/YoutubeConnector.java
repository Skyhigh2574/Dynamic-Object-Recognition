    ...
    public class YoutubeConnector {
        ...
        public static final String KEY = "AIzaSyA8HpHZoK363l9jgLDWi3O5LWwSZiy0rYo";

        //Package name of the app that will call the YouTube Data API
        public static final String PACKAGENAME = "ml.uncoded.yts.searchyoutube";

        //SHA1 fingerprint of APP can be found by double clicking on the app signing report on right tab called gradle
        public static final String SHA1 = "CA:CC:77:34:A2:9A:EA:A3:04:C8:5C:F2:C4:F1:6C:E9:22:78:A5:7C";
