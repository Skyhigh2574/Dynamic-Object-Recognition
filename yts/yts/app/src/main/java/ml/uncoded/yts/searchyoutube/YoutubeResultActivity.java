...
public class YoutubeResultActivity extends AppCompatActivity {
    private static final String TAG = "YoutubeResultActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String search=getIntent().getStringExtra("Search_String");
        searchOnYoutube(search);
        mProgressDialog.setMessage("Finding videos for "+search);
    ...
    private void searchOnYoutube(final String keywords){
        ...
        new Thread(){
            ...
            public void run(){
                ...
                YoutubeConnector yc = new YoutubeConnector(YoutubeResultActivity.this);
